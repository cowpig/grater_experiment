...
var computeAnimations = function computeAnimations(state, animations, timestamp) {
	// compute animations using step function based on state and start time

	var next_step = new _immutable.Map(animations).filter(function (animation) {
		return animation.step;
	}).map(function (animation, scope) {
		var current = state[scope];
		var delta = timestamp - animation.start_time;
		return new _immutable.Map(animation.step(current, delta));
	});
...
var drawing_runloop = function drawing_runloop(timestamp) {
	...
	var current_tick = computeAnimations(window.state, window.animations, timestamp);
	render(current_tick);
...
},{"immutable":2,"redux":9}],2:[function(require,module,exports){
/**
...
},{"./createStore":8,"./utils/warning":10,"_process":3,"lodash/isPlainObject":14}],7:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":14}],9:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":4,"./bindActionCreators":5,"./combineReducers":6,"./compose":7,"./createStore":8,"./utils/warning":10,"_process":3}],10:[function(require,module,exports){
'use strict';
...
},{"./_getPrototype":11,"./_isHostObject":12,"./isObjectLike":13}]},{},[1]);
